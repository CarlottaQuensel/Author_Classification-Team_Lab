...
class MetricFeatures():
    ...
    # def __init__(self):
    #     average_dictionary = {}
    #     self.average_dictionary = average_dictionary
    #     list_smaller_5 = []
    #     self.list_smaller_5 = list_smaller_5
    ...
    def open_file(self):
        ...
        #data_frame_head = {k: new_dictionary[k] for k in list(new_dictionary)[2:6]}
        #print(data_frame_head)
...
metric_features.determine_bin('And I think, that this is a good thing. \n As I know that it is. \n And now, bye.')
print(metric_features.determine_bin('And I think, that this is a good thing. \n As I know that it is. \n And now, bye.'))
